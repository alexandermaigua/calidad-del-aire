...
const DashboardPage: React.FC = () => {
  ...
  return (
    <>
      <header className="p-6 pt-20 md:pt-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-white border border-slate-200 shadow-lg rounded-2xl p-4 flex flex-col justify-between col-span-1 sm:col-span-2 lg:col-span-1">
            <div>
                ...
                <div className="text-4xl md:text-6xl font-extrabold bg-gradient-to-r from-orange-400 to-red-500 text-transparent bg-clip-text">{latestReadings.aqi}</div>
            </div>
          ...
          <div className="bg-white border border-slate-200 shadow-lg rounded-2xl p-4 col-span-1 sm:col-span-2 lg:col-span-1">
            <div className="flex items-center gap-4">
                ...
                <div className="text-3xl md:text-4xl font-bold text-slate-800">{weather.tempC.toFixed(1)}°C</div>
            </div>
...
const AlertsPage = () => {
    ...
    return (
        <>
            <header className="p-6 pt-20 md:pt-6 flex justify-between items-center">
...
const Sidebar: React.FC<{ isOpen: boolean; toggle: () => void }> = ({ isOpen, toggle }) => {
  ...
  return (
    <aside className={`fixed top-0 left-0 bottom-0 bg-slate-800 text-white p-4 flex flex-col z-20 transition-all duration-300 ${isOpen ? 'w-64' : 'w-0 p-0'}`}>
...
const Layout: React.FC<PropsWithChildren> = ({ children }) => {
  ...
  return (
    <div className="flex">
      ...
      <div className={`min-h-screen bg-slate-100 transition-all duration-300 ${isSidebarOpen ? 'ml-64 w-[calc(100%-256px)]' : 'ml-0 w-full'}`}>
        <button onClick={toggleSidebar} className="fixed top-4 left-4 z-30 p-2 bg-slate-800 text-white rounded-md md:hidden">

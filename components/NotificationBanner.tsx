...
export const NotificationBanner: React.FC<NotificationBannerProps> = ({ onAllow, onBlock }) => {
  return (
    <div className="fixed bottom-0 left-0 w-full bg-slate-800 text-white p-4 flex flex-col sm:flex-row sm:justify-between sm:items-center text-center sm:text-left">
